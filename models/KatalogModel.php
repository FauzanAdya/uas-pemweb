...
class KatalogModel {
    ...
    public function simpan($data) {
        $stmt = $this->db->prepare(
            "INSERT INTO katalog (nama, deskripsi, harga_dasar, kategori, foto) VALUES (?,?,?,?,?)"
        );
        $stmt->bind_param("ssiss", $data['nama'], $data['deskripsi'], $data['harga_dasar'], $data['kategori'], $data['foto']);
        return $stmt->execute();
    }
